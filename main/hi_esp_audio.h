...
// MAX98357A I2S 引腳配置（I2S_NUM_1，避免與麥克風衝突）
#define I2S_SPEAKER_NUM         I2S_NUM_1
#define I2S_SPEAKER_BCK_PIN     GPIO_NUM_8   // BCLK（不與麥克風重複）
#define I2S_SPEAKER_WS_PIN      GPIO_NUM_9   // LRC（不與麥克風重複）
#define I2S_SPEAKER_DATA_PIN    GPIO_NUM_10  // DIN（不與麥克風重複）
#define I2S_SPEAKER_SD_PIN      GPIO_NUM_7   // SD (開關控制)
